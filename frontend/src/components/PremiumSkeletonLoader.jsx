...
const PremiumSkeletonLoader = ({ className = "" }) => {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-r from-transparent via-neutral-700/20 to-transparent animate-pulse"
        style={{
          background:
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center space-y-4 px-4 max-w-2xl mx-auto">
          {/* Title skeleton */}
          <div
            className="h-8 sm:h-10 bg-neutral-700 rounded-lg mx-auto animate-pulse"
            style={{ width: "280px" }}
          />

          {/* Subtitle skeleton */}
          <div
            className="h-4 bg-neutral-700/60 rounded-lg mx-auto animate-pulse"
            style={{ width: "320px" }}
          />
