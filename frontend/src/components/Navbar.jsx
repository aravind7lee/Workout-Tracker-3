          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  "-8px 0 32px rgba(0, 0, 0, 0.8), inset 1px 0 0 rgba(71, 85, 105, 0.3)",
                ...
                {isAuthenticated() && user ? (
                  <motion.div
                    ...
                    style={{
                      ...
                      background:
                        "linear-gradient(180deg, rgba(30, 41, 59, 0.3), rgba(15, 23, 42, 0.8))",
                    }}
                  >
                    <div
                      className="flex items-center space-x-3 mb-3 sm:mb-4 p-3 rounded-xl"
