  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-4 border-b border-neutral-800 space-y-3 bg-neutral-950/50">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          {filteredExercises.length === 0 ? (
            <div className="text-center py-12 text-neutral-500">
              ...
              <p className="text-xs text-neutral-600 mt-1">Try a different search term or category filter</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-xs text-orange-400 font-medium">{ex.categoryName}</span>
                        {ex.difficulty && (
                          <span className="text-[10px] px-2 py-0.5 rounded bg-neutral-800 text-neutral-400 capitalize">
                            {ex.difficulty}
                          </span>
                        )}
                        {ex.type && (
