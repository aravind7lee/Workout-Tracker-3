    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-[9999]" onClick={onClose}>
      <div className="card max-w-lg w-full max-h-[90vh] overflow-y-auto relative" onClick={e => e.stopPropagation()}>
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-slate-400">Configure your workout parameters before starting</p>
          <button 
            onClick={onClose} 
        ...
        <div className="flex items-center gap-4 mb-6 p-4 bg-slate-800/50 rounded-lg">
          ...
          <div>
            ...
            <p className="text-slate-400">{exercise.category} • {exercise.difficulty}</p>
            <p className="text-sm text-slate-500">Recommended: {exercise.sets}</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {presetConfigs.map((preset) => (
              <button
                ...
                className="p-3 bg-slate-800/30 hover:bg-slate-700/50 rounded-lg text-left transition-colors"
              >
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="text-sm text-slate-400 min-w-[60px]">
        ...
        <div className="bg-slate-800/30 rounded-lg p-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span className="text-slate-400">Reps per Set:</span>
