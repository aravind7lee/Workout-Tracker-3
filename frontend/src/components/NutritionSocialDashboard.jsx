import { BicepsFlexed, Trophy, Scale, Target, Utensils, Calendar, Dna, FlaskConical, Star, Upload, MessageCircle, Camera, Twitter, ClipboardList } from 'lucide-react';
import React, { useState, useEffect, useMemo } from "react";
import { motion, AnimatePresence } from "framer-motion";


const NutritionSocialDashboard = ({
  totals,
  targets,
  meals,
  customCalorieTarget,
  ...
  const currentAchievements = useMemo(() => {
    ...
    const calorieProgress =
      ((totals.calories || 0) / currentCalorieTarget) * 100;
    ...
    if (macroBalance.every((m) => m >= 80 && m <= 120)) {
      achievements.push({
        ...
        type: "daily",
        icon: /*#__PURE__*/ React.createElement(FlaskConical, {
          className: "w-[1em] h-[1em] inline-block",
        }),
  ...
  const generateShareContent = () => {
    ...
    return {
      ...
      hashtags:
        "#NutritionTracking #HealthyEating #FitnessGoals #WorkoutTracker",
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            {
              className:
                "w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-red-700 to-pink-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-red-700/30",
            },
            /*#__PURE__*/ React.createElement(
              "span",
              {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            "span",
            {
              className: "relative flex items-center gap-1 sm:gap-1.5 md:gap-2",
            },
            /*#__PURE__*/ React.createElement(
              "span",
              null,
    ...
    currentAchievements.length > 0 &&
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-2.5 md:gap-3 lg:gap-4",
          },
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  /*#__PURE__*/ React.createElement(
                    "h5",
                    {
                      className: `font-black text-[10px] sm:text-xs md:text-sm ${achievement.color} uppercase tracking-wide leading-tight`,
                    },
                    achievement.title,
                  ),
                  /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            motion.div,
            {
              ...
              className:
                "bg-light-bg-primary dark:bg-dark-bg-primary rounded-2xl p-6 max-w-md w-full shadow-2xl",
            ...
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "bg-gray-50 dark:bg-dark-bg-tertiary/30 rounded-lg p-4 mb-6",
              },
              /*#__PURE__*/ React.createElement(
                "div",
                {
                  className:
                    "text-sm text-light-text-primary dark:text-dark-text-primary whitespace-pre-line",
                },
                shareContent.text,
              ),
              /*#__PURE__*/ React.createElement(
                "div",
                {
                  className: "text-xs text-red-700 dark:text-red-500 mt-2",
                },
                shareContent.hashtags,
              ),
            ),
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  ...
                  className:
                    "flex items-center justify-center gap-2 p-3 bg-red-600 text-white rounded-lg hover:bg-green-600 transition-all",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  null,
              ...
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  ...
                  className:
                    "flex items-center justify-center gap-2 p-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  null,
              ...
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  ...
                  className:
                    "flex items-center justify-center gap-2 p-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  null,
              ...
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  ...
                  className:
                    "flex items-center justify-center gap-2 p-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-all",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  null,
