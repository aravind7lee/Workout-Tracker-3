...
class RealTimeEventDispatcher {
  ...
  showAchievementNotification(achievement) {
    ...
    notification.className = 'fixed top-4 right-4 bg-gradient-to-r from-yellow-600 to-yellow-700 text-white px-6 py-4 rounded-lg shadow-lg z-50 max-w-sm';
  ...
  async syncOfflineData() {
    try {
      ...
      const pendingMeals = JSON.parse(localStorage.getItem('pendingMeals') || '[]');
