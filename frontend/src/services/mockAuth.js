...
export const mockRegister = async (userData) => {
  ...
  const existingUser = MOCK_USERS.find(user => user.email === email.toLowerCase());
  if (existingUser) {
...
export const isBackendAvailable = async () => {
  try {
    ...
    const backendUrl = import.meta.env.VITE_API_BASE || 'https://grindx-backend.vercel.app/api';
