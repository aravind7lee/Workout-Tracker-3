import { Dumbbell, Plus, Save, ArrowLeft, Target, Calendar, Clock, Users, Trash2, ChevronUp, ChevronDown, Play, RefreshCw, CheckCircle2, XCircle, AlertTriangle, BicepsFlexed, Star, Bomb, Activity, Zap, Edit, Globe, BarChart3, Book, Moon, Circle, Medal } from 'lucide-react';
            ...
            Object.keys(split.weeklySchedule).forEach((day) => {
              if (newWeeklyPlan[day]) {
                ...
                if (dayWorkout === "Rest Day") {
                  ...
                  const exercises =
                    split.exercises?.filter((ex) => ex.day === day) || [];
                  newWeeklyPlan[day] = {
                    exercises,
                    isRestDay: false,
                  };
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                "span",
                {
                  className: `${statusDisplay.color} font-medium hidden sm:inline-flex items-center gap-1`,
                },
                statusDisplay.icon,
                " ",
                statusDisplay.text,
              ...
              /*#__PURE__*/ React.createElement(
                "span",
                {
                  className: `${statusDisplay.color} font-medium sm:hidden`,
                },
                statusDisplay.icon,
              ),
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  ...
                  className: `text-xs px-2 sm:px-3 py-1 rounded-full ${autoSave ? "bg-blue-900/30 text-blue-300 border border-blue-700" : "bg-neutral-800/50 text-neutral-400 border border-neutral-700"}`,
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  {
              ...
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  onClick: loadDraft,
                  className:
                    "text-xs px-2 sm:px-3 py-1 rounded-full bg-purple-900/30 text-purple-300 border border-purple-700",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  {
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          editMode
            ? "🔄 EDITING WORKOUT SPLIT 🏋️"
            : "Custom Workout Split Builder 🏋️",
        ),
        editMode &&
          /*#__PURE__*/ React.createElement(
            "div",
      ...
      /*#__PURE__*/ React.createElement(
        "div",
        {
          className: `border rounded-lg p-4 ${currentMuscleGroup.color}/20 border-orange-500/30 transition-all duration-300 mb-6`,
        },
        /*#__PURE__*/ React.createElement(
          "div",
          {
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    /*#__PURE__*/ React.createElement("div", {
                      className:
                        "bg-gradient-to-r from-red-700 to-red-600 h-2 rounded-full transition-all duration-300",
                      style: {
                        width: `${Math.min((getTotalExercises() / 10) * 100, 100)}%`,
                      },
                    }),
                  ),
                  /*#__PURE__*/ React.createElement(
                    ...
                    Math.min(Math.round((getTotalExercises() / 10) * 100), 100),
                    "%",
                  ),
                ),
              ),
      ...
      /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement("span", null, "Select Day"),
              ),
              /*#__PURE__*/ React.createElement(
                "div",
                {
                  className:
                    "text-xs bg-orange-500/20 text-orange-300 px-2 py-1 rounded-full border border-orange-500/30",
                },
                selectedDay,
              ),
            ),
              ...
              days.map((day) =>
                /*#__PURE__*/ React.createElement(
                  "button",
                  {
                    ...
                    className: `p-2 rounded-lg text-xs font-medium transition-all duration-200 border active:scale-95 ${selectedDay === day ? "bg-orange-600 text-white shadow-lg border-orange-400/50 ring-1 ring-orange-400/50" : weeklyPlan[day]?.isRestDay ? "bg-gray-600 text-gray-300 border-gray-500/50" : (weeklyPlan[day]?.exercises?.length || 0) > 0 ? "bg-green-600/30 text-green-300 border-red-600/50" : "bg-neutral-800/50 text-neutral-300 border-neutral-700/50"}`,
                  },
                  /*#__PURE__*/ React.createElement(
                    "div",
                    {
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              "button",
              {
                ...
                className: `w-full p-3 sm:p-4 rounded-xl font-medium transition-all duration-300 text-sm sm:text-base border ${weeklyPlan[selectedDay]?.isRestDay ? "bg-gray-600 text-white border-gray-500/50 shadow-lg" : "bg-neutral-800/50 text-neutral-300 hover:bg-gray-600/50 border-neutral-700/50 hover:border-gray-500/50"}`,
              },
              /*#__PURE__*/ React.createElement(
                "div",
                {
          ...
          !weeklyPlan[selectedDay]?.isRestDay &&
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "text-xs sm:text-sm font-medium text-white mb-2 flex items-center gap-2",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  null,
                ...
                Object.entries(exerciseLibrary).map(([key, group]) =>
                  /*#__PURE__*/ React.createElement(
                    "button",
                    {
                      ...
                      className: `p-3 sm:p-4 rounded-xl text-xs sm:text-sm font-medium transition-all duration-300 border ${selectedMuscleGroup === key ? `${group.color} text-white shadow-lg border-white/20 scale-105` : "bg-neutral-800/50 text-neutral-300 hover:bg-neutral-700/50 border-neutral-700/50 hover:border-neutral-500/50 hover:scale-102"}`,
                    },
                    /*#__PURE__*/ React.createElement(
                      "div",
                      {
                ...
                exercises.map((exercise, index) => {
                  ...
                  return /*#__PURE__*/ React.createElement(
                    "div",
                    {
                      ...
                      className: `p-3 sm:p-4 rounded-xl border cursor-grab active:cursor-grabbing transition-all duration-300 select-none transform hover:scale-[1.01] sm:hover:scale-[1.02] ${isInSplit ? "bg-green-900/30 border-green-700/50 shadow-green-900/20 shadow-lg" : "bg-neutral-900/60 border-neutral-800/50 hover:bg-neutral-800/60 hover:border-neutral-700/50 hover:shadow-md"}`,
                    },
                    /*#__PURE__*/ React.createElement(
                      "div",
                      {
                      ...
                      /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(
                          ...
                          {
                            className:
                              "flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-2",
                          },
                          /*#__PURE__*/ React.createElement(
                            "div",
                            {
                          ...
                          isInSplit &&
                            /*#__PURE__*/ React.createElement(
                              ...
                              {
                                className:
                                  "text-red-500 text-xs bg-green-900/30 px-2 py-1 rounded-full border border-green-700/50 flex-shrink-0 self-start sm:self-auto",
                              },
                              "\u2713 Added",
                            ),
                        ),
                        /*#__PURE__*/ React.createElement(
                          ...
                          {
                            className:
                              "flex flex-wrap items-center gap-1 sm:gap-2 text-xs sm:text-sm text-neutral-400",
                          },
                          /*#__PURE__*/ React.createElement(
                            "span",
                            {
                              className:
                                "flex items-center gap-1 bg-neutral-800/40 px-2 py-1 rounded border border-neutral-700/50",
                            },
                            /*#__PURE__*/ React.createElement(
                              "span",
                              null,
                          ...
                          /*#__PURE__*/ React.createElement(
                            "span",
                            {
                              className: `px-2 py-1 rounded text-xs border font-medium ${exercise.difficulty === "beginner" ? "bg-green-900/30 text-green-300 border-green-700/50" : exercise.difficulty === "intermediate" ? "bg-yellow-900/30 text-yellow-300 border-yellow-700/50" : "bg-red-900/30 text-red-300 border-red-700/50"}`,
                            },
                            exercise.difficulty,
                          ),
                          /*#__PURE__*/ React.createElement(
                            ...
                            {
                              className:
                                "text-neutral-500 flex items-center gap-1 bg-neutral-800/30 px-2 py-1 rounded border border-neutral-700/50",
                            },
                            /*#__PURE__*/ React.createElement(
                              "span",
                              null,
                      ...
                      /*#__PURE__*/ React.createElement(
                        ...
                        {
                          className:
                            "flex flex-col sm:flex-row items-center gap-1 sm:gap-2 flex-shrink-0",
                        },
                        /*#__PURE__*/ React.createElement(
                          "button",
                          {
                            ...
                            disabled: isInSplit,
                            className: `text-base sm:text-lg font-bold w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-lg transition-all duration-300 border ${isInSplit ? "text-red-500 bg-green-900/30 border-green-700/50 cursor-not-allowed" : "text-red-500 hover:text-blue-300 hover:bg-blue-900/20 border-blue-700/50 hover:border-red-700/50 hover:scale-105"}`,
                          },
                          isInSplit ? "✓" : "+",
                        ),
                        /*#__PURE__*/ React.createElement(
                          ...
                          {
                            className:
                              "text-neutral-500 text-base sm:text-lg cursor-grab hidden sm:block",
                          },
                          "\u22EE\u22EE",
                        ),
                      ),
        ...
        /*#__PURE__*/ React.createElement(
          "div",
          {
            className: `bg-neutral-900/60 border border-neutral-800 rounded-xl p-3 sm:p-4 lg:p-6 min-h-[400px] sm:min-h-[500px] transition-all duration-300 ${dragOverArea === "split" ? "bg-green-900/30 border-red-500 shadow-xl ring-2 ring-red-500/50 scale-[1.01] sm:scale-[1.02]" : "hover:bg-neutral-900/80 hover:border-neutral-700"}`,
            onDragOver: handleDragOver,
          ...
          /*#__PURE__*/ React.createElement(
            ...
            {
              className:
                "flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-5 gap-3 sm:gap-0",
            },
            /*#__PURE__*/ React.createElement(
              "div",
              {
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "text-lg sm:text-xl lg:text-2xl font-bold text-white flex items-center gap-2 sm:gap-3",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  {
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    editMode ? "Edit Split" : "Custom Split",
                  ),
                ),
              ),
              getTotalExercises() > 0 &&
                /*#__PURE__*/ React.createElement(
                  ...
                  {
                    className:
                      "text-xs sm:text-sm text-red-500 font-medium flex items-center gap-1",
                  },
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "text-xs sm:text-sm font-medium text-neutral-300 bg-neutral-800/60 px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-neutral-700 shadow-sm",
                },
                /*#__PURE__*/ React.createElement(
                  "span",
                  {
          ...
          getCurrentDayExercises().length === 0
            ? /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "flex items-center justify-center min-h-[300px] sm:min-h-[400px] border-2 border-dashed border-neutral-700 rounded-xl transition-all duration-300 hover:border-neutral-500 hover:bg-neutral-900/30 mx-1",
                },
                /*#__PURE__*/ React.createElement(
                  "div",
                  {
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    {
                      className:
                        "text-4xl sm:text-6xl mb-3 sm:mb-4 animate-bounce",
                    },
                    /*#__PURE__*/ React.createElement(Target, {
                      className: "w-[1em] h-[1em] inline-block",
                    }),
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    {
                      className:
                        "text-neutral-300 text-lg sm:text-xl font-semibold mb-2",
                    },
                    weeklyPlan[selectedDay]?.isRestDay
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    {
                      className:
                        "text-neutral-400 text-sm sm:text-base mb-4 sm:mb-6 max-w-xs mx-auto leading-relaxed",
                    },
                    weeklyPlan[selectedDay]?.isRestDay
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    /*#__PURE__*/ React.createElement(
                      ...
                      {
                        className:
                          "bg-gradient-to-r from-red-700/10 to-red-600/10 rounded-lg p-3 sm:p-4 border border-red-700/20",
                      },
                      /*#__PURE__*/ React.createElement(
                        "p",
                        {
                          className:
                            "text-purple-300 text-sm sm:text-base font-semibold mb-2",
                        },
                    ...
                    /*#__PURE__*/ React.createElement(
                      ...
                      {
                        className:
                          "grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 max-w-sm mx-auto",
                      },
                      Object.entries(muscleGroupMapping).map(([name, config]) =>
                        /*#__PURE__*/ React.createElement(
                          "div",
                          {
                            key: name,
                            className:
                              "text-center p-2 sm:p-3 bg-neutral-900/40 rounded-lg border border-neutral-800/50 hover:border-neutral-700/50 transition-all duration-300",
                          },
                          /*#__PURE__*/ React.createElement(
                            "div",
                            {
                    ...
                    /*#__PURE__*/ React.createElement(
                      ...
                      {
                        className:
                          "flex items-center justify-center gap-2 text-sm text-neutral-500 bg-neutral-900/30 rounded-full px-4 py-2 border border-neutral-800/50",
                      },
                      /*#__PURE__*/ React.createElement(
                        "span",
                        {
            ...
            : /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "space-y-3 sm:space-y-4 lg:space-y-6 max-h-[400px] sm:max-h-[500px] lg:max-h-[600px] overflow-y-auto",
                },
                (() => {
                          ...
                          exercises.map((exercise, exerciseIndex) => {
                            ...
                            return /*#__PURE__*/ React.createElement(
                              "div",
                              {
                                ...
                                draggable: true,
                                onDragStart: (e) =>
                                  handleDragStart(e, exercise, "split"),
                                onDragEnd: handleDragEnd,
                                className:
                                  "group p-3 sm:p-4 rounded-lg bg-gradient-to-r from-neutral-900/60 via-neutral-800/40 to-neutral-900/60 border border-neutral-700/50 cursor-grab active:cursor-grabbing transition-all duration-300 hover:from-neutral-800/70 hover:via-neutral-700/50 hover:to-neutral-800/70 hover:border-neutral-500/70 hover:shadow-lg select-none transform hover:scale-[1.005] sm:hover:scale-[1.01] active:scale-[0.995] sm:active:scale-[0.99]",
                              },
                              /*#__PURE__*/ React.createElement(
                                "div",
                                {
                                ...
                                /*#__PURE__*/ React.createElement(
                                  ...
                                  /*#__PURE__*/ React.createElement(
                                    "span",
                                    {
                                      className: `text-white font-bold text-xs sm:text-sm ${config.color} bg-opacity-80 w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 rounded-full flex items-center justify-center border border-neutral-700 shadow-sm group-hover:shadow-md transition-all duration-300`,
                                    },
                                    exerciseIndex + 1,
                                  ),
                                ),
                                /*#__PURE__*/ React.createElement(
                                  ...
                                  /*#__PURE__*/ React.createElement(
                                    ...
                                    /*#__PURE__*/ React.createElement(
                                      ...
                                      {
                                        className:
                                          "text-xs bg-neutral-800/60 text-neutral-300 px-2 py-1 rounded-md border border-neutral-700 self-start sm:self-auto",
                                      },
                                      "\u2713 In Split",
                                    ),
                                  ),
                                  /*#__PURE__*/ React.createElement(
                                    ...
                                    /*#__PURE__*/ React.createElement(
                                      ...
                                      {
                                        className:
                                          "flex items-center gap-1 bg-neutral-800/40 px-2 py-1 rounded border border-neutral-700",
                                      },
                                      /*#__PURE__*/ React.createElement(
                                        "span",
                                        null,
                                    ...
                                    exercise.difficulty &&
                                      /*#__PURE__*/ React.createElement(
                                        "span",
                                        {
                                          className: `px-2 py-1 rounded text-xs font-medium border ${exercise.difficulty === "beginner" ? "bg-green-900/30 text-green-300 border-green-700/50" : exercise.difficulty === "intermediate" ? "bg-yellow-900/30 text-yellow-300 border-yellow-700/50" : "bg-red-900/30 text-red-300 border-red-700/50"}`,
                                        },
                                        exercise.difficulty,
                                      ),
                                  ),
                                ...
                                /*#__PURE__*/ React.createElement(
                                  ...
                                  /*#__PURE__*/ React.createElement(
                                    ...
                                    /*#__PURE__*/ React.createElement(
                                      "button",
                                      {
                                        ...
                                        className:
                                          "text-neutral-400 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed text-sm w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded hover:bg-neutral-700/50 transition-all duration-200 active:scale-95",
                                      },
                                      /*#__PURE__*/ React.createElement(
                                        ChevronUp,
                                        {
                                  ...
                                  /*#__PURE__*/ React.createElement(
                                    "button",
                                    {
                                      ...
                                      className:
                                        "text-red-400 hover:text-red-300 text-lg font-bold w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded hover:bg-red-900/30 transition-all duration-200 active:scale-95",
                                    },
                                    "\xD7",
                                  ),
                                  /*#__PURE__*/ React.createElement(
