...
const initialExercises = [
  { id: 'exercise-1', name: 'Bench Press', category: 'Chest', sets: '3x8-12' },
  { id: 'exercise-2', name: 'Squat', category: 'Legs', sets: '3x8-12' },
  { id: 'exercise-3', name: 'Deadlift', category: 'Back', sets: '3x5-8' },
  { id: 'exercise-4', name: 'Pull-up', category: 'Back', sets: '3x6-10' },
  { id: 'exercise-5', name: 'Push-up', category: 'Chest', sets: '3x10-15' },
  { id: 'exercise-6', name: 'Plank', category: 'Core', sets: '3x30-60s' }
];
...
export default function PlansBuilderHTML5() {
  ...
  const savePlan = useCallback(() => {
    ...
    console.log('Saving plan:', { name: planName, exercises: plan });
            ...
            <div className="space-y-2 sm:space-y-3">
              {plan.map((exercise, index) => (
                <div
                  ...
                  onDragEnd={handleDragEnd}
                  className="p-3 sm:p-4 rounded-lg bg-green-900/20 border border-green-700/50 cursor-grab active:cursor-grabbing transition-all duration-200 hover:bg-green-800/20 hover:border-green-600/50"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="text-red-400 hover:text-red-300 text-lg font-bold w-6 h-6 flex items-center justify-center rounded hover:bg-red-900/20 transition-colors"
