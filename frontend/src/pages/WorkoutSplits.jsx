...
const WorkoutSplits = () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          localStorage.setItem(
            `workout_splits_favorites_${userId}`,
  ...
  const fallbackSplits = [
    {
      ...
      duration: "60-75 min",
      description:
        "Custom muscle pairing split with legs & biceps, shoulders & triceps, chest & back rotation",
      weeklySchedule: {
        Monday:
      ...
      benefits: [
        "Unique muscle pairing",
        "High frequency training",
        "Balanced upper/lower split",
      ],
      bestFor:
        "Intermediate to advanced lifters wanting a unique muscle pairing approach",
    },
    {
      id: 13,
      name: "5-Day Split",
      ...
      duration: "60-75 min",
      description:
        "Modified custom split with mid-week rest and combined arm day",
      weeklySchedule: {
        Monday:
          "Legs & Biceps - Quadriceps, Hamstrings, Glutes, Calves, Biceps",
        Tuesday: "Shoulders & Triceps - All shoulder muscles, Triceps",
      ...
      bestFor:
        "Intermediate lifters who prefer more rest days and combined arm training",
    },
    {
      id: 1,
    ...
    },
    {
      ...
      duration: "45-60 min",
      description:
        "Traditional bodybuilding split focusing on one muscle group per day",
      weeklySchedule: {
      ...
      benefits: [
        ...
        "Great muscle isolation",
        "Bodybuilding focused",
      ],
      bestFor:
        "Advanced lifters focused on bodybuilding and muscle specialization",
    },
    {
      id: 4,
      ...
      muscles: {
        "Each Session":
          "All major muscle groups - Chest, Back, Shoulders, Arms, Legs, Abs",
      },
    ...
    },
    {
      ...
      muscles: {
        "Daily Focus":
          "Same muscles trained 3-4x per week with varying intensity",
      },
      benefits: [
        "Maximum growth stimulus",
        "Skill practice",
        "Fast adaptation",
      ],
  ...
  const loadCustomSplits = () => {
    try {
      ...
      console.log(
        `✅ Loaded ${userSplits.length} user-specific splits for user ${user?.id || user?._id}`,
      );
      return userSplits;
    } catch (error) {
  ...
  const filteredSplits = workoutSplits.filter((split) => {
    const matchesCategory =
      selectedCategory === "all" || split.category.includes(selectedCategory);
    const matchesSearch =
  ...
  return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        !heroImageLoaded &&
          /*#__PURE__*/ React.createElement(
            ...
            {
              className:
                "absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-800 animate-pulse",
            },
            /*#__PURE__*/ React.createElement("div", {
              className:
                "absolute inset-0 bg-gradient-to-r from-transparent via-orange-500/10 to-transparent animate-shimmer",
            }),
          ),
        /*#__PURE__*/ React.createElement(
          "div",
          ...
          heroImageError &&
            /*#__PURE__*/ React.createElement("div", {
              className:
                "w-full h-full bg-gradient-to-br from-orange-900 via-red-900 to-black",
            }),
          /*#__PURE__*/ React.createElement("div", {
            className:
              "absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30",
          }),
          /*#__PURE__*/ React.createElement("div", {
            className:
              "absolute inset-0 bg-gradient-to-r from-orange-500/20 via-transparent to-red-500/20",
          }),
        ),
        /*#__PURE__*/ React.createElement(
          "div",
          ...
          /*#__PURE__*/ React.createElement(
            "div",
            {
              className: "text-center px-3 sm:px-6 lg:px-8 max-w-6xl",
            },
            /*#__PURE__*/ React.createElement(
              motion.div,
              {
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "inline-flex items-center px-3 sm:px-4 py-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 backdrop-blur-md rounded-full border border-orange-500/30 mb-4 sm:mb-6",
                },
                /*#__PURE__*/ React.createElement(Dumbbell, {
                  className: "w-4 h-4 sm:w-5 sm:h-5 text-orange-400 mr-2",
                }),
                /*#__PURE__*/ React.createElement(
                  "span",
                  {
                    className:
                      "text-orange-300 font-semibold text-xs sm:text-sm tracking-wide",
                  },
            ...
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-4 sm:mb-6",
                style: {
                  background:
                  ...
                  textShadow:
                    "0 0 30px rgba(245, 158, 11, 0.5), 0 0 60px rgba(239, 68, 68, 0.3)",
                },
                initial: {
                  opacity: 0,
                  y: 30,
            ...
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "text-sm sm:text-base lg:text-lg xl:text-xl text-gray-200 font-medium mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-2",
                style: {
              ...
              "Choose the perfect workout split for your goals. Whether you're bulking, cutting, or maintaining, we have the ideal training program to maximize your results.",
            ),
            /*#__PURE__*/ React.createElement(
              motion.div,
              {
                className:
                  "flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 mt-6 sm:mt-8 px-4 sm:px-0",
                initial: {
                  opacity: 0,
                  y: 20,
                },
              ...
              /*#__PURE__*/ React.createElement(
                motion.button,
                {
                  ...
                  className:
                    "premium-btn-primary btn-primary preserve-color w-full sm:w-auto justify-center",
                },
                "Create Your Split",
                /*#__PURE__*/ React.createElement(
                  "svg",
              ...
              /*#__PURE__*/ React.createElement(
                motion.button,
                {
                  ...
                  className:
                    "premium-btn-secondary btn-secondary preserve-color w-full sm:w-auto justify-center",
                },
                "Your Splits",
              ),
            ),
    ...
    /*#__PURE__*/ React.createElement(
      ...
      {
        className:
          "bg-gradient-to-r from-gray-950 via-black to-gray-950 py-4 sm:py-6 md:py-8",
      },
      /*#__PURE__*/ React.createElement(
        "div",
        {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2 sm:gap-4 md:gap-6",
            initial: {
              opacity: 0,
              y: 20,
            },
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "font-semibold text-white text-xs sm:text-sm md:text-base tracking-wide",
              },
              "13 DIFFERENT SPLITS",
            ),
          ),
    ...
    /*#__PURE__*/ React.createElement(
      ...
      {
        className:
          "bg-gradient-to-r from-gray-950 via-black to-gray-950 border-y border-orange-500/20",
      },
      /*#__PURE__*/ React.createElement(
        "div",
        {
          className: "max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-6 md:py-8",
        },
        /*#__PURE__*/ React.createElement(
          "div",
          {
            className:
              "flex flex-col lg:flex-row gap-4 sm:gap-6 items-start lg:items-center justify-between",
          },
          /*#__PURE__*/ React.createElement(
            "div",
            {
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(Search, {
                className:
                  "absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-orange-400 w-4 h-4 sm:w-5 sm:h-5 z-10 transition-colors duration-300",
              }),
              ...
              searchTerm &&
                /*#__PURE__*/ React.createElement(
                  "button",
                  {
                    ...
                    className:
                      "absolute right-3 sm:right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-white transition-colors duration-300 bg-gray-700/50 hover:bg-gray-600/50 rounded-full p-1",
                  },
                  "\u2715",
                ),
            ),
      ...
      loading &&
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement("div", {
              className:
                "animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-orange-400",
            }),
            /*#__PURE__*/ React.createElement(
              "span",
              {
      ...
      !loading &&
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            {
              className:
                "bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-md border border-gray-700/50 rounded-3xl p-12 max-w-md mx-auto",
            },
            /*#__PURE__*/ React.createElement(
              "div",
              {
                className:
                  "bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6",
              },
            ...
            /*#__PURE__*/ React.createElement(
              ...
              "Try adjusting your filters or search terms to find the perfect split for your goals.",
            ),
            /*#__PURE__*/ React.createElement(
              "button",
              {
                ...
                className:
                  "bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105",
              },
              "Reset Filters",
            ),
          ),
    ...
    selectedSplit &&
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "bg-gradient-to-br from-gray-900 to-black rounded-2xl sm:rounded-3xl max-w-4xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto border border-gray-700/50 shadow-2xl",
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                "button",
                {
                  onClick: () => setSelectedSplit(null),
                  className:
                    "text-gray-400 hover:text-white transition-colors text-lg sm:text-xl p-1",
                },
                "\u2715",
              ),
            ),
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                "div",
                {
                  className: "bg-gray-800/50 rounded-lg p-3 sm:p-4 text-center",
                },
                /*#__PURE__*/ React.createElement(Calendar, {
                  className:
                    "w-5 h-5 sm:w-6 sm:h-6 text-red-500 mx-auto mb-1 sm:mb-2",
                }),
                /*#__PURE__*/ React.createElement(
                  "div",
                  {
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(Clock, {
                  className:
                    "w-5 h-5 sm:w-6 sm:h-6 text-red-600 mx-auto mb-1 sm:mb-2",
                }),
                /*#__PURE__*/ React.createElement(
                  "div",
                  {
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  {
                    className:
                      "text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3",
                  },
                  /*#__PURE__*/ React.createElement(Calendar, {
                    className: "w-[1em] h-[1em] inline-block",
                  }),
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  Object.entries(selectedSplit.weeklySchedule).map(
                    ([day, workout]) => {
                      const isRestDay =
                        workout.includes("Rest") || workout === "Rest Day";
                      const groupedExercises = isRestDay
                        ? {}
                        : groupExercisesByMuscleGroup(workout);
                      return /*#__PURE__*/ React.createElement(
                        "div",
                        {
                          key: day,
                          className: `rounded-lg border overflow-hidden ${isRestDay ? "bg-gray-700/20 border-gray-600/30" : "bg-red-600/10 border-red-600/20"}`,
                        },
                        /*#__PURE__*/ React.createElement(
                          "div",
                          {
                            className:
                              "flex items-center justify-between p-3 border-b border-gray-600/30",
                          },
                          /*#__PURE__*/ React.createElement(
                            "div",
                            {
                              className: "font-medium text-red-500 text-lg",
                            },
                            day,
                          ),
                          /*#__PURE__*/ React.createElement(
                            "div",
                            {
                              className: `text-xs px-2 py-1 rounded-full ${isRestDay ? "bg-gray-600 text-gray-300" : "bg-red-600/20 text-blue-300"}`,
                            },
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  Object.entries(selectedSplit.muscles).map(
                    ([day, muscles]) => {
                      const groupedMuscles =
                        groupExercisesByMuscleGroup(muscles);
                      return /*#__PURE__*/ React.createElement(
                        "div",
                        {
                          key: day,
                          className:
                            "bg-gray-700/30 rounded-lg border border-gray-600/30 overflow-hidden",
                        },
                        /*#__PURE__*/ React.createElement(
                          "div",
                          {
                            className:
                              "bg-gray-800/50 px-3 py-2 border-b border-gray-600/30",
                          },
                          /*#__PURE__*/ React.createElement(
                            "div",
                            {
                                ...
                                .map(([muscleGroup, exercises]) => {
                                  ...
                                  return /*#__PURE__*/ React.createElement(
                                    ...
                                    /*#__PURE__*/ React.createElement(
                                      "span",
                                      {
                                        className: `${config.color} bg-opacity-80 text-white text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center`,
                                      },
                                      config.icon,
                                    ),
                                    /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  selectedSplit.benefits.map((benefit, index) =>
                    /*#__PURE__*/ React.createElement(
                      ...
                      /*#__PURE__*/ React.createElement("span", null, benefit),
                    ),
                  ),
                ),
              ),
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  "p",
                  {
                    className: "text-gray-300 bg-gray-700/30 rounded-lg p-3",
                  },
                ...
                isAuthenticated() &&
                  /*#__PURE__*/ React.createElement(
                    "button",
                    {
                      ...
                      className: `flex items-center justify-center space-x-2 font-medium py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-colors duration-200 text-sm sm:text-base ${favorites.includes(selectedSplit.id) ? "bg-red-600 hover:bg-red-700 text-white" : "bg-gray-700 hover:bg-gray-600 text-white"}`,
                    },
                    /*#__PURE__*/ React.createElement(Heart, {
                      size: 14,
                      className: "sm:w-4 sm:h-4",
                      fill: favorites.includes(selectedSplit.id)
                        ? "currentColor"
                        : "none",
                    }),
                    /*#__PURE__*/ React.createElement(
                      "span",
                      null,
                      favorites.includes(selectedSplit.id) ? "Saved" : "Save",
                    ),
                  ),
              ),
            ),
