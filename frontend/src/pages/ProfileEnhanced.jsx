    ...
    <AuthGuard>
      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-30 max-w-7xl mx-auto px-4 py-8">
          ...
          >
            <motion.h1 
              className="text-6xl md:text-8xl font-black mb-4 bg-gradient-to-r from-red-500 via-orange-500 to-red-500 bg-clip-text text-transparent"
            ...
            >
              ...
              <button
                onClick={fetchProfileData}
                disabled={loading}
                className="px-6 py-3 bg-gradient-to-r from-red-700 to-red-800 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-full shadow-lg shadow-red-600/25 transition-all duration-300 disabled:opacity-50"
              >
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900/80 to-black/80 backdrop-blur-xl border border-neutral-800/50 shadow-2xl shadow-black/50">
                ...
                <div className="relative z-10 p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div className="px-3 py-1 bg-red-600/20 text-red-500 text-xs font-bold rounded-full border border-red-600/30">
                      CLOUDINARY
                    </div>
                  </div>
                  <ImageUploader
                  ...
                  />
                  <div className="mt-6 p-4 bg-gradient-to-r from-neutral-900/50 to-neutral-800/50 rounded-2xl border border-neutral-700/30">
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    {!editing && (
                      <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-red-700 to-red-800 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-full shadow-lg transition-all duration-300"
                      >
                        ✏️ EDIT
                      </button>
                    )}
                    ...
                    <form onSubmit={handleSaveProfile} className="space-y-6">
                      ...
                      <div className="flex gap-4 pt-4">
                        <button
                          type="submit"
                          disabled={saving}
                          className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-red-600 hover:to-red-600 text-white font-bold rounded-full shadow-lg transition-all duration-300 disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          className="px-8 py-3 bg-gradient-to-r from-neutral-700 to-neutral-800 hover:from-neutral-500 hover:to-neutral-700 text-white font-bold rounded-full shadow-lg transition-all duration-300"
                        >
                          CANCEL
                        </button>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse"></div>
                            <span className="text-red-500 font-bold">Active • Real-time Sync Enabled</span>
                          </div>
                        </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900/80 to-black/80 backdrop-blur-xl border border-neutral-800/50 shadow-2xl shadow-black/50">
              ...
              <div className="relative z-10 p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                  <motion.div 
                    className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-700/20 to-blue-800/20 border border-red-600/30 p-6 hover:scale-105 transition-transform duration-300"
                    whileHover={{ scale: 1.05 }}
                  >
                    <div className="text-center">
                      <div className="text-4xl font-black text-red-500 mb-2">{stats?.totalWorkouts || 0}</div>
                      <div className="text-sm text-neutral-300 font-bold uppercase tracking-wider">Total Workouts</div>
                  ...
                  <motion.div 
                    className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-600/20 to-green-800/20 border border-red-600/30 p-6 hover:scale-105 transition-transform duration-300"
                    whileHover={{ scale: 1.05 }}
                  >
                    <div className="text-center">
                      <div className="text-4xl font-black text-red-500 mb-2">{stats?.totalMeals || 0}</div>
                      <div className="text-sm text-neutral-300 font-bold uppercase tracking-wider">Meals Logged</div>
                      {stats?.totalMeals > 0 && (
                  ...
                  <motion.div 
                    className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-800/20 to-purple-800/20 border border-red-700/30 p-6 hover:scale-105 transition-transform duration-300"
                    whileHover={{ scale: 1.05 }}
                  >
                    <div className="text-center">
                      <div className="text-4xl font-black text-red-600 mb-2">{stats?.xpPoints || 0}</div>
                      <div className="text-sm text-neutral-300 font-bold uppercase tracking-wider">XP Points</div>
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="text-sm text-neutral-300 font-bold uppercase tracking-wider">Day Streak</div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                  <div className="text-center p-4 bg-neutral-900/50 rounded-xl border border-neutral-800/50">
                    <div className="text-2xl font-black text-red-400 mb-1">{stats?.totalCaloriesBurned || 0}</div>
                    <div className="text-xs text-neutral-400 font-bold uppercase tracking-wider">Calories Burned</div>
                  </div>
                  <div className="text-center p-4 bg-neutral-900/50 rounded-xl border border-neutral-800/50">
                    <div className="text-2xl font-black text-red-500 mb-1">{stats?.totalPlans || 0}</div>
                    <div className="text-xs text-neutral-400 font-bold uppercase tracking-wider">Workout Plans</div>
                  </div>
                  <div className="text-center p-4 bg-neutral-900/50 rounded-xl border border-neutral-800/50">
                    <div className="text-2xl font-black text-yellow-400 mb-1">{stats?.membershipDays || 0}</div>
                    <div className="text-xs text-neutral-400 font-bold uppercase tracking-wider">Days Member</div>
                  </div>
                </div>
                
                {(!stats?.totalWorkouts && !stats?.totalMeals) && (
                  <motion.div 
                    className="text-center py-12 border-2 border-dashed border-neutral-700 rounded-2xl bg-neutral-900/30"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 0.5 }}
                  >
                    ...
                    <p className="text-neutral-400 mb-6 text-lg">Complete your first workout or log a meal to see real-time progress here.</p>
                    <div className="flex gap-4 justify-center flex-wrap">
                      <button 
                        onClick={() => navigate('/library')}
                        className="px-8 py-4 bg-gradient-to-r from-red-700 to-red-800 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-full shadow-lg transition-all duration-300"
                      >
                        🏋️ START WORKOUT
                      </button>
                      <button 
                        onClick={() => navigate('/nutrition')}
                        className="px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-red-600 hover:to-red-600 text-white font-bold rounded-full shadow-lg transition-all duration-300"
                      >
                        🍎 LOG MEAL
                      </button>
                      <button 
                        onClick={() => navigate('/my-plans')}
                        className="px-8 py-4 bg-gradient-to-r from-red-800 to-pink-600 hover:from-red-700 hover:to-pink-500 text-white font-bold rounded-full shadow-lg transition-all duration-300"
                      >
                        📋 CREATE PLAN
                      </button>
                    </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900/80 to-black/80 backdrop-blur-xl border border-neutral-800/50 shadow-2xl shadow-black/50">
              <div className="relative z-10 p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <motion.button 
                    onClick={() => navigate('/my-plans')}
                    className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-700/20 to-blue-800/20 border border-red-600/30 p-8 hover:scale-105 transition-all duration-300"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="text-center">
                  ...
                  <motion.button 
                    ...
                    className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-800/20 to-purple-800/20 border border-red-700/30 p-8 hover:scale-105 transition-all duration-300"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="text-center">
                  ...
                  <motion.button 
                    onClick={() => navigate('/nutrition')}
                    className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-600/20 to-green-800/20 border border-red-600/30 p-8 hover:scale-105 transition-all duration-300"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="text-center">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900/80 to-black/80 backdrop-blur-xl border border-neutral-800/50 shadow-2xl shadow-black/50">
                <div className="relative z-10 p-8">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div className="px-4 py-2 bg-red-600/20 text-red-500 text-sm font-bold rounded-full border border-red-600/30">
                  ...
                  <div className="space-y-4 max-h-80 overflow-y-auto">
                    {activity.slice(0, 8).map((item, index) => (
                      <motion.div 
                        key={item.id}
                        className="flex items-center gap-4 p-4 bg-neutral-900/50 rounded-xl border border-neutral-800/50 hover:bg-neutral-900/70 transition-colors"
                    ...
                    {achievements.slice(0, 6).map((achievement, index) => (
                      ...
                      >
                        <div className="text-center">
                          ...
                          <div className="text-neutral-400 text-sm mb-3">{achievement.description}</div>
